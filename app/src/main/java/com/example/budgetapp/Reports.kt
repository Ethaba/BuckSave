...
class Reports : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        showEmptyBreakdown(tvTotalSpent)
        ...
        btnGenerateReport.setOnClickListener {
            ...
            generateReport(username, startDateText, endDateText, tvTotalSpent, tvReportInsight)
        }
    }
    ...
    private fun generateReport(
        ...
        when {
            maxGoal == 0.0 -> {
                ...
                tvReportInsight.setTextColor(android.graphics.Color.rgb(0, 80, 184))
            }

            totalSpent < minGoal -> {
                tvReportInsight.text = "You are below your minimum spending goal"
                tvReportInsight.setTextColor(android.graphics.Color.rgb(255, 140, 0))
            }

            totalSpent > maxGoal -> {
                tvReportInsight.text = "You exceeded your maximum budget"
                tvReportInsight.setTextColor(android.graphics.Color.RED)
            }

            else -> {
                tvReportInsight.text = "Good job! Your spending is within your planned range"
                tvReportInsight.setTextColor(android.graphics.Color.rgb(0, 138, 69))
            }
        }
    ...
    private fun showEmptyBreakdown(tvTotalSpent: TextView) {
    ...
    private fun showMessage(message: String) {
        ...
        text.setTextColor(android.graphics.Color.DKGRAY)
    ...
    private fun addBreakdownRow(category: String, amount: Double) {
        ...
        categoryText.setTextColor(android.graphics.Color.BLACK)
